...
// 		else
// 			return Vector2D();
// 	} // так как функци€ возвращает как бы временный объект Vector2D а не указатель, то будет вызван ещЄ 1 раз деструктор Vector2D, после вызова функции 
//
// private:
// 	float health;
// 	Vector2D* location;
...
//
// GameStats::GameStats()
// 	: GameStats(1, 1) // нельз€ к делегирующему конструкотору добавить другой!
// {
// 	cout << "Default constructor invoked." << endl;
// }
//
...
int main()
{
	...
	// // demoFunction();
	//
	// // Entity entity1{ 5 }; // спискова€ инициализаци€
	//
	// // Entity entity1, entity2;
	//
	// // entity1.s_Member = 5;
